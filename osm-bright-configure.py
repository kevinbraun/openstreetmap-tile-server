...
config["land-high"] = path.join(getcwd(),"osm-bright/shp/land-polygons-split-3857/land_polygons.shp")
config["land-low"] = path.join(getcwd(),"osm-bright/shp/simplified-land-polygons-complete-3857/simplified_land_polygons.shp")
...
config["ne_places"] = path.join(getcwd(),"osm-bright/shp/10m-populated-places-simple.shp")
