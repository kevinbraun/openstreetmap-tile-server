...
config["path"] = path.expanduser("./build")
...
config["land-high"] = path.join(getcwd(),"osm-night/shp/land-polygons-split-3857/land_polygons.shp")
config["land-low"] = path.join(getcwd(),"osm-night/shp/simplified-land-polygons-complete-3857/simplified_land_polygons.shp")
...
config["ne_places"] = path.join(getcwd(),"osm-night/shp/10m-populated-places-simple.shp")
